<template>
  <div>
      <div class="flex">
        ...
        <div class="text-red-600 border p-3 rounded border-red-600 transition hover:bg-red-600 hover:text-white cursor-pointer mr-5" @click="deleteFromDb('deleteNews', $route.params.id)" v-if="admin && showDelete">Да</div>
      </div>
