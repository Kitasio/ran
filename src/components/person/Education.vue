<template>
    ...
    <div v-if="jsonData.length" class="mb-3 font-nova-bold text-2xl">Образование, учёные степени и учёные звания</div>
    <div class="grid grid-cols-1 space-y-5">
        <div v-for="data in jsonData" :key="data.id" @click.alt="deleteFromDb('deleteEducation', data.id.toString())">
