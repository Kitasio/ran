<template>
    ...
    <div v-if="jsonData.length > 0" class="mb-3 font-nova-bold text-2xl">Достижения и поощрения</div>
    <div class="grid grid-cols-1 space-y-1">
        <div v-for="data in jsonData" :key="data.id" @click.alt="deleteFromDb('deleteAchievement', data.id.toString())">
